  	...
  	<div class="modal-dialog">
  		<div class="modal-content">
  			<div class="modal-header">
  				...
  				<h4 class="modal-title" id="myModalLabel">Tambah Data Jenis Pemotretan</h4>
  			</div>
  			<div class="modal-body">
  				<form action="prosesWisata.php?aksi=tambah" method="post" enctype="multipart/form-data">
  					...
  					<div class="col-md-12">
  						...
  						<div class="form-group">
  							<textarea name="konten" class="form-control" cols="30" rows="7" placeholder="Alamat"></textarea>
  						</div>
  					</div>
