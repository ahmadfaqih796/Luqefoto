...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Tambah Data Studio Foto</h4>
        </div>

        <div class="modal-body">
        <form action="prosesPenginapan.php?aksi=tambah" method="post" enctype="multipart/form-data">
               ...
               <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nama" name="hotel">
                  </div>
                </div>
                  <div class="col-md-6">
                  <label>Harga</label>
       ...
       <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <textarea name="ket_hotel" class="form-control" cols="30" rows="7" placeholder="Alamat"></textarea>
