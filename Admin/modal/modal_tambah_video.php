	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="prosesVideo.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="col-md-6">
						<label>Judul</label>
					...
					<div class="col-md-6">
						<label>Link</label>
						<div class="form-group">
							<input type="text" class="form-control" placeholder="link video" name="url">
						</div>
					</div>
					<div class="col-md-12">
						<label>Deskripsi</label>
						<div class="form-group">
							<textarea name="deskripsi" class="form-control" cols="30" rows="7" placeholder="deskripsi video"></textarea>
						</div>
					</div>
