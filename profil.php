		...
		<div id="fh5co-contact" class="fh5co-section-gray">
			...
			<div class="container">
				...
				<form action="proses.php?aksi=update" method="post" enctype="multipart/form-data">
					<?php
					$query	= mysqli_query($kon, "SELECT * FROM tbl_user WHERE id_user = '$id_user'");
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<p>
											<input type="radio" name="jekel" value="L" <?php if ($d['jekel'] == "L") {
																																		echo "checked";
																																	} ?>>Pria<br />
											<input type="radio" name="jekel" value="P" <?php if ($d['jekel'] == "P") {
																																		echo "checked";
																																	} ?>>Wanita
										</p>
									</div>
